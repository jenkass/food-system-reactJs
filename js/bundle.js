...
function timer(id, deadline) {
    ...
    function getReminderTime(endtime) {
    ...
    function setClock(selector, endtime) {
        const timer = document.querySelector(selector),
            ...
            timerDelay = setInterval(updateClock, 1000);

        updateClock();

        function updateClock() {
            const t = getReminderTime(endtime);
...
window.addEventListener('DOMContentLoaded', () => {
    const modalTimerId = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_3__.openModalWindow)('.modal', modalTimerId), 50000);
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__.default)('.timer', '2021-04-01');
});
})();
